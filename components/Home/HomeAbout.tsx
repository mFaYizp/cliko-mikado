  ...
  return (
    <section className="w-full min-h-screen flex items-center justify-center overflow-hidden">
      <div className="container mx-auto w-full max-w-[100vw] flex flex-col md:flex-row md:flex-nowrap items-center md:items-start justify-between py-16 md:py-36 gap-y-10 px-4">
        ...
        {/* Image Section */}
        <div className="w-full md:w-1/2 flex justify-center md:justify-start pb-10 sm:pb-20">
          <ParallaxProvider>
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start justify-center gap-y-6 md:gap-y-10 text-center md:text-left min-h-full pt-12 sm:pt-20">
          <p className="text-[#CCCCCC] font-light text-[1.25rem] md:text-[1.75rem] max-w-[35ch]">
          ...
          <Button className="font-normal text-[1.25rem] md:text-[1.75rem] px-8 py-4 md:px-10 md:py-6 flex items-center space-x-2">
